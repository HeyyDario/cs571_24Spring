...
function calculateSalesTax() {
	...
	salesTax = roundMoney(getSalesTaxRateForState(state) * calculateSubtotal());
	return salesTax; // TODO calculateSalesTax
}
...
document.getElementById("btn-checkout").addEventListener("click", () => {
	let total = (calculateSubtotal() + calculateSalesTax()).toFixed(2);
